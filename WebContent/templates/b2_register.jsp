...
<div class="visa_page_buttons">
	...
	<br><br><input type="text" id="sec_question" name="sec_question"><br><br>
	<button class="fill_the_form" onclick="window.location.href='./tour_page1.jsp'">Fill the form</button>
